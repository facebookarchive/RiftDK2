/**
  *********************************************************************************
  * @file    Libraries/STM32_CPAL_Driver/devices/stm32l1xx/cpal_i2c_hal_stm32l1xx.h
...
#ifndef ___CPAL_I2C_HAL_STM32L1XX_H
#define ___CPAL_I2C_HAL_STM32L1XX_H
...
|--------|---------|--------------|-----------|------------------|-------------------------|
|        |   SCL   |  GPIO_Pin_10 |   GPIOB   | GPIO_PinSource10 |   RCC_AHBPeriph_GPIOB   |                                          
|  I2C2  |---------|--------------|-----------|------------------|-------------------------|
|        |   SDA   |  GPIO_Pin_11 |   GPIOB   | GPIO_PinSource11 |   RCC_AHBPeriph_GPIOB   |                                          
|--------|---------|--------------|-----------|------------------|-------------------------|    
...
/*----------- I2C1 Device -----------*/
/* For STM32L1XX family there are two possible configurations of I2C1 pins:
...
/* I2Cx TX and RX DMA channels for STM32L1XX family are fixed */
...
#define I2C1_IT_EVT_PREPRIO             I2C1_IT_OFFSET_PREPRIO + 1   /* I2C1 EVT PREEMPTION PRIORITY */ 
...
#define I2C2_IT_EVT_PREPRIO             I2C2_IT_OFFSET_PREPRIO + 1   /* I2C2 EVT PREEMPTION PRIORITY */ 
...
#endif /*___CPAL_I2C_HAL_STM32L1XX_H */
