...
Filename    :   mpu6500_register_map.h
Content     :   Invensense MPU-6500 gyro/accel register map
Created     :
Authors     :   Nirav Patel
...
#ifndef _MPU6500_REGISTER_MAP_H_
#define _MPU6500_REGISTER_MAP_H_

// Registers and bit settings for the Invensense MPU-6500
// Supports most other Invensense gyros with minor mods

// Registers specific to the MPU6500
#define SELF_TEST_X_G   0x00
#define SELF_TEST_Y_G   0x01
#define SELF_TEST_Z_G   0x02
...
#define YG_ST           (1 << 6)
#define ZG_ST           (1 << 5)
#define FCHOICE_B_8800  (1)
#define FCHOICE_B_3600  (1 << 1)
...
#define ACCEL_FCHOICE_B (1 << 3)
#define A_DLPG_CFG_0    (0)
#define A_DLPG_CFG_1    (1)
#define A_DLPG_CFG_2    (2)
#define A_DLPG_CFG_3    (3)
#define A_DLPG_CFG_4    (4)
#define A_DLPG_CFG_5    (5)
#define A_DLPG_CFG_6    (6)
#define A_DLPG_CFG_7    (7)
...
#endif /* _MPU6500_REGISTER_MAP_H_ */
